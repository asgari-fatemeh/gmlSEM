...
sam5 = '(x11,x12,x13) for y1,...,(x81,x82,x83) as for',  #in defining latent variables within a family:block
...
sam7 = '(x11,x12 for y11,y12),(x21,x22 for y11,y12),...,(x81,x82 for y81,y82)', 
...
sam9 = 'beta1*scale(x1)+...+beta9*scale(9)'
)
