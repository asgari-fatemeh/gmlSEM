...
sam2 = 'y1a,y2b,...,y5e',
sam3 = 'x1,x3,...,x9',
sam4 = '(x11,x12,x13),(x12,x13,x14),...,(x81,x82,x83)',  #in defining vector-valued distributions in the family: block
sam5 = '(x11,x12,x13) for y1,...,(x81,x82,x83) for y8',  #in defining latent variables within a family:block
sam5 = 'x1 for (z1,y1),...,x8 for (z8,y8)',  #as in zero-inflated distributions
...
sam6 = 'x1 for y1,x2 for y2,...,x8 for y8', 
sam7 = '(x11,x12 for y21,y22),(x21,x22 for y11,y12),...,(x81,x82 for y81,y82)', 
sam8 = '(x11,x12) for (y21,y22),(x21,x22) for (y11,y12),...,(x81,x82) for (y81,y82)', 
...
sam9 = 'beta1*scale(x1)+...+beta9*scale(x9)'
)

for(i in seq_along(samples)){

  expa=expand.all.seqs(samples[[i]])
