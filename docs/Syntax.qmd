...
In @exm-lev2, the 'Student performance' is modeled against the 'Student Attitude' and the 'Class Climate'. In the next model we model 'Student performance' on ''Class Climate' and the centered 'Student Attitude'.
