...
The next model defines three measurement models for three latent variables in a three level model.
...
In @exm-lev2, the second level is class nested within school as the third level. Both 2^nd^ and 3^rd^ levels and their nested structure are understood in the second line, and hence the first line is redundant. The model will remain unchanged if you omit the first line.
