...
The *gmlSEM* syntax for the model depicated at @fig-3-level-2 is:
    ...
    model<-'level: class within school
            ...
            a   ~ (1[as c.c]|class)
            c.c ~ (1[as s.c]|school)
            p   ~ beta * cent(a) + c.c + s.c + (1[as c.p]|class)'
